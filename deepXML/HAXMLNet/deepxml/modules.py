...
#        print("inputs size: ",inputs.size())
        ...
        val = self.dropout(outputs[torch.argsort(idx)])
...
#        print("Inside MLAttention")
        self.counter += 1
#        print("before mask: ",masks.size())
        masks = torch.unsqueeze(masks, 1)  # N, 1, L
#        print("after mask: ",masks.size())
...
#        print(type(attention.cpu().detach().numpy()))
        filepath = "{}/results/attn_score_{}_amazon670.npy".format(os.getcwd(),file_name)
