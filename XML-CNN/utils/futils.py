...
def save_load_data(params, save=1):
...
def load_batch_cnn(x_tr, y_tr, params, idx = 0,batch=True, batch_size=0, decoder_word_input=None, decoder_target=None, testing=0):
    ...
    if(batch):
        if(batch_size):
            ...
            #x_tr, y_tr = x_tr[(idx-1)*params.num_mb,idx*params.num_mb], y_tr[(idx-1)*params.num_mb,idx*params.num_mb]
        else:
            ...
            x_tr, y_tr = x_tr[(idx-1)*params.mb_size:idx*params.mb_size,:], y_tr[(idx-1)*params.mb_size:idx*params.mb_size,:]
