...
def pad_sentences(sentence_sets, padding_word="<PAD/>", max_length=5000):
    sequence_length = 0
...
def build_vocab(sentences, params, vocab_size=100000):
...
def load_data(params, max_length=5000, vocab_size=100000):
    #Load and preprocess data
    if params.data_set == 'rcv':
    ...
    test = getData(path+'test_raw_texts.txt',path+'test_labels.txt')
